...
// selected auth enables websockets. The downstream client may still use HTTP/SSE;
// this executor keeps that local API stable while using the upstream websocket
// channel for Codex requests.
